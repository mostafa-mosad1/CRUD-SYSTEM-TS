import { IallInputs, IproductList } from "../interface/interface";
import { v4 as uuidv4 } from "uuid";
uuidv4(); // ⇨ '9b1deb4d-3b7d-4bad-9bdd-2b0d7b3dcb6d'

export let productList: IproductList[] = [
  {
    id: uuidv4(),
    title: "Nike Shoes",
    description:
...
export const allInputs: IallInputs[] = [
  {
    type: "text",
    lable: "Product Title",
    id: "title",
...
export const AllColorsShow: string[] = [
  "#a855f7",
  "#2563eb",
  "#84D2C5",
  "#13005A",
